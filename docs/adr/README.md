...
ADR-0003 的 trusted script 加载模型仍有效，旧版本安排与示意 API 不代表当前实现。ADR-0004–0007 已随 v1.3.0 落地；0009 / 0010 已随 v1.4.0 落地；0011 已随 v1.5.0 发布。0008 的嵌入预览已随 v1.6.0 发布；2026-09-23 起不交付 SDK，接入见 [接入说明](../integrate.md)。0006 的已落地 Play 契约继续兼容维护，不另开商店。ADR 的“已接受”表示决策状态；当前阶段以路线图为准。
